# AI School Platform - AWS Infrastructure
...
terraform {
  ...
  # backend "s3" {
  #   bucket         = "ai-school-terraform-state"
...
resource "aws_secretsmanager_secret" "app_secrets" {
  ...
  description = "Application secrets for AI School Platform"
...
resource "aws_secretsmanager_secret_version" "app_secrets" {
  ...
  secret_string = jsonencode({
    ...
    DIRECT_URL        = "postgresql://${var.db_username}:${var.db_password}@${aws_db_instance.postgres.endpoint}/${var.db_name}"
...
# ALB Listeners (HTTP redirect and HTTPS)
...
# Set acm_certificate_arn variable in terraform.tfvars
